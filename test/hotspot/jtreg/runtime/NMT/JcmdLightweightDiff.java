...
/*
 * @test
 * @summary run NMT baseline, allocate memory and verify output from light.diff
 * @library /test/lib
 * @modules java.base/jdk.internal.misc
 *          java.management
 * @build jdk.test.whitebox.WhiteBox
 * @run driver jdk.test.lib.helpers.ClassFileInstaller jdk.test.whitebox.WhiteBox
 * @run main/othervm -Xbootclasspath/a:. -XX:+UnlockDiagnosticVMOptions -XX:+WhiteBoxAPI -XX:NativeMemoryTracking=light JcmdLightweightDiff
 */
...
public class JcmdLightweightDiff {
    ...
    public static void main(String args[]) throws Exception {
        ...
        pb.command(new String[] { JDKToolFinder.getJDKTool("jcmd"), pid, "VM.native_memory", "light.diff", "scale=KB"});
