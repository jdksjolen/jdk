 ...
 * @run main/othervm -Xbootclasspath/a:. -XX:+UnlockDiagnosticVMOptions -XX:NativeMemoryTracking=light -XX:+WhiteBoxAPI LightweightSanityCheck
 */
...
public class LightweightSanityCheck {
  ...
  public static void main(String args[]) throws Exception {
    ...
    // Run  'jcmd <pid> VM.native_memory light scale=KB'
    pb.command(new String[] { JDKToolFinder.getJDKTool("jcmd"), pid, "VM.native_memory", "light", "scale=KB"});
